...
### 1. Prerequisites
- **Node.js** (v20.x or later) or **Bun** (v1.1+)
- **Git**
- A **Supabase** project ([supabase.com](https://supabase.com))
- An **AI API Key** ([OpenRouter](https://openrouter.ai), [Google AI Studio](https://aistudio.google.com), or [OpenAI](https://platform.openai.com))
...
3. This provisions all tables (`profiles`, `projects`, `generations`, `credit_transactions`), RLS security policies, RPC credit functions, and the `renders` storage bucket.
